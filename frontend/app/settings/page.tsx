  ...
  return (
    <div className="space-y-6 font-mono select-none max-w-4xl">
      ...
      <div className="p-5 rounded-lg bg-red-950/20 border border-red-900/50 space-y-3">
        ...
        <div className="pt-2 flex items-center gap-2 text-[10px] text-slate-400 border-t border-red-900/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div
            ...
            className={`p-3.5 rounded-lg border cursor-pointer transition-colors ${
              provider === "local"
                ? "bg-nexus-900/40 border-nexus-600 text-white"
                : "bg-surface-raised border-border text-slate-400 hover:border-slate-600"
            }`}
          >
            <div className="flex items-center justify-between font-bold">
              <span>Local Engine (Default)</span>
              {provider === "local" && <CheckCircle2 className="w-4 h-4 text-nexus-400" />}
            </div>
          ...
          >
            <div className="flex items-center justify-between font-bold">
              ...
              {provider === "openai" && <CheckCircle2 className="w-4 h-4 text-nexus-400" />}
            </div>
            <p className="text-[10px] text-slate-400 mt-1">
          ...
          >
            <div className="flex items-center justify-between font-bold">
              ...
              {provider === "gemini" && <CheckCircle2 className="w-4 h-4 text-nexus-400" />}
            </div>
            <p className="text-[10px] text-slate-400 mt-1">
      ...
      <div className="p-5 rounded-lg bg-surface border border-border space-y-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-[11px]">
          <div className="p-2.5 rounded bg-surface-raised border border-border">
            <span className="text-slate-400 block text-[10px]">Graph Engine</span>
          ...
          <div className="p-2.5 rounded bg-surface-raised border border-border">
            <span className="text-slate-400 block text-[10px]">Backend Framework</span>
